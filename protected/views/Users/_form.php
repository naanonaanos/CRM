           ...
           <div class="col-md-6">
			<div class="row">
				<?php 
					...
					{
						echo $form->labelEx($model,'username');
						echo $form->textField($model,'username',array('class'=>'form-control','size'=>50,'maxlength'=>50));
						echo $form->error($model,'username');	
					}
				?>
			</div>
			...
			<div class="row">
				<?php
					if(Yii::app()->user->getState('groupName')=='development')
					{
						echo $form->labelEx($model,'position');
						echo $form->dropDownList($model, 'position', array(
								...
								array('class'=>'form-control', 'id'=>'position')
							);
